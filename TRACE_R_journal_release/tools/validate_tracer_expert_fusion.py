#!/usr/bin/env python3
"""Run the validation-only TRACE-R controlled-study evaluator.

The command preserves the frozen v50 protocol while exposing the journal
method name. The script is restartable, hashes checkpoints and outputs, rejects
test-labelled inputs, and selects only on the joint IVCNZ/PCM validation
endpoint.
"""
