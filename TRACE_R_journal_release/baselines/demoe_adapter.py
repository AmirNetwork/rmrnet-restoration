...
# The DeMoE implementation and weights retain their upstream authorship/license.
...
class DeMoEAdapter(nn.Module):
    ...
    def __init__(
        ...
        if weights:
            # This repository-managed checkpoint includes path/config objects,
            # so PyTorch 2.6's tensor-only default cannot deserialize it.
