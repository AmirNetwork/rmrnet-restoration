...
\input{tables/table_training_audit}

\input{tables/table_checkpoints}
...
The subsequent 13-frame temporal block contains 49 ground-truth objects. Its complete ranked comparison is reported once in the main paper; the block was inspected during prior development and is therefore supportive rather than newly sealed evidence.
