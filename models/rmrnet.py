...
class RMRNet(RCADNet):
    ...
    where I_d is the degraded/native road image and z is either the
    metadata-conditioned degradation code or the image-estimated fallback code.
    The optional phi/lambda maps below are retained only for legacy ablations;
    the final paper uses active contours after detection, not as deployed masks.
    ...
    def load_pretrained_compat(
        ...
        *,
        ...
        Because the auxiliary contour head and detail skip add new parameters,
        strict=False is the recommended default for old checkpoints.
        """
