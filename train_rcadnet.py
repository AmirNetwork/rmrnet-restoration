...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--conditioning", choices=["film", "gated_basis"], default="gated_basis")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "image-only metadata-control audit, or shuffled to condition each "
...
def smoke_test(
    ...
    result = model_forward(
        ...
        or (args.conditioning == "gated_basis" and args.basis_sparsity_weight > 0),
    )
    outputs = result["restored"]
...
def main() -> None:
    print(
        ...
        "use train_rmrnet.py for paper-facing runs."
    )
    args = parse_args()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch in loader:
            ...
            with torch.amp.autocast(device_type=device.type, enabled=use_amp):
                ...
                # Manuscript training objective:
                #   L = base_weight * L_base
                #       + lambda_code L_code
                #       + lambda_s L_sparse_basis
                #       + lambda_TDP L_TDP
                #       + lambda_J L_J
                #       + lambda_anchor L_anchor
                #       + lambda_NR L_evidence_nonregression
                #       + lambda_DC L_detail_copy.
                # The active-contour loss is intentionally zero in the final
                # config; contours are a post-detection measurement stage.
