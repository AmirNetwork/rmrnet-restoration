...
The RMR-P column follows the frozen guarded dual-view policy. Frames that
...
METHODS = (
    ...
    ("rmr_guarded_dual_view", "RMR-P", None),
)
        ...
        json.dumps(
            {
                ...
                "rmr_checkpoint": "runs/rmrnet_crid_complete_ins_semantic_tdp_public_stage_v8_20260812/rcadnet_epoch_001.pth",
                "rmr_policy": "validation-frozen guarded dual-view policy",
                "rmr_policy_freeze": str((GUARDED / "frozen_policy_before_supportive_test.json").relative_to(ROOT)),
                "native_tile_normalization": "actual accumulated weight clamped only by numerical epsilon",
                "rmr_frame_decisions": decisions,
