...
"""Sensor-routed restoration expert bank used by the deployed RMR-P policy.
...
class RMRPExpertFusion(nn.Module):
    ...
    def __init__(
        ...
        policy: ExpertFusionPolicy | None = None,
    ) -> None:
        super().__init__()
        self.demoe = demoe
        self.dfpir = dfpir
        self.instructir = instructir
        self.policy = policy or ExpertFusionPolicy()
